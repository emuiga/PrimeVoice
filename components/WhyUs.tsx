  ...
  return (
    <section id="why-us" className="relative py-24 bg-brand-surface overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="relative w-full aspect-[4/5] sm:aspect-[16/9] lg:aspect-[21/9] bg-brand-dark">
            <Image
            ...
            <div
              ...
              style={{ background: 'linear-gradient(to top, rgba(26,10,46,0.92) 0%, rgba(26,10,46,0.55) 45%, rgba(26,10,46,0.15) 100%)' }}
              aria-hidden="true"
            />
          </div>
          ...
          <div className="absolute inset-x-0 bottom-0 p-6 sm:p-10 lg:p-14">
            ...
            <ul className="flex flex-col gap-2 mb-8">
              {checklist.map((point) => (
                <li
                  key={point}
                  className="inline-flex w-fit items-center gap-2.5 text-sm text-white bg-black/35 backdrop-blur-sm rounded-full pl-2 pr-4 py-1.5"
                >
            ...
            <div className="flex flex-col xs:flex-row sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-brand-orange text-white text-sm font-medium px-7 py-3.5 rounded-lg hover:bg-orange-600 transition-colors tracking-wide"
              ...
              <Link
                href="/portfolio"
                className="inline-flex items-center justify-center gap-2 border border-white/30 text-white text-sm font-medium px-7 py-3.5 rounded-lg hover:bg-white hover:text-black transition-colors tracking-wide"
              >
                See Our Work
              </Link>
            </div>
