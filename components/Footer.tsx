...
export default function Footer() {
  ...
  return (
    /*
     * The video element drives the footer height so it never clips.
     * All content layers sit absolutely on top of it.
     */
    <footer className="relative overflow-hidden">

      {/* ── Video — natural width × height, no cropping ── */}
      <video
        autoPlay
        muted
        loop
        ...
        aria-hidden="true"
        preload="none"
        style={{ minHeight: '520px', objectFit: 'cover' }}
      />

      {/* ── Strong overlay so content is always legible ── */}
      ...
      <div className="absolute inset-0 z-10 flex flex-col">
        <div className="flex-1 max-w-7xl mx-auto w-full px-6 lg:px-8 pt-14 sm:pt-20 pb-6 flex flex-col justify-between">
          ...
          {/* Top: brand + columns */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-12 pb-12 border-b border-white/10">
            ...
            >
              ...
              {/* Always-visible brand name in case logo renders as icon only */}
              <p
                className="text-white text-xl font-semibold tracking-wide mb-3"
